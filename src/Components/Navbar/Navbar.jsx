            ...
            <header className={`${navbarStyle.myNav}`}>
                <nav className={`navbar navbar-expand-lg navbar-dark ${navbarStyle.myNavBackground}  p-4`}>
                    <div className="container">
                        ...
                        <button className={`navbar-toggler p-2 ${navbarStyle.toggleStyle}`} type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation" >
